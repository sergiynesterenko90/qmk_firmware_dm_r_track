...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LAYER_F3] = LAYOUT_5x6_right(
       ...
       _______,_______,_______,_______,_______,_______,                        KC_MS_BTN3,CARRET_MODE,DRAGSCROLL_MODE,SNIPING,_______,_______,
       _______,_______,_______,_______,_______,_______,                        KC_WWW_BACK,KC_MS_BTN1,KC_MS_BTN2,KC_WWW_FORWARD,_______,_______,
       _______,_______,_______,_______,_______,_______,                        _______,_______,_______,LCTL(KC_TAB),_______,_______,
                       _______,_______,                                                        _______ ,_______,
                                               _______,_______,                _______,
                                               _______,_______,                _______,
                                               _______,_______,         _______,LCTL(KC_W)
  ),
};
